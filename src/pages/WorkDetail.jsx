...
export default function WorkDetail() {
  ...
  useEffect(() => {
    ...
    tl.to(
      clone,
      { x: centerX, y: centerY, duration: 0.75, ease: "power3.inOut" },
      0.05,
    );
      ...
      >
        ...
        <section className="site-grid pt-[17.5rem] s:pt-[22.5rem]">
          ...
          >
            <h1
              ...
              style={{
                fontSize: "clamp(3.5rem, 5.4vw, 14rem)",
          ...
          <div className="col-span-5 s:col-start-2 s:col-span-6 mt-[5rem] s:mt-[8rem] js-t-fade">
            ...
            <ul className="flex flex-col gap-[0.6rem]">
              {work.tags.map((tag) => (
                <li key={tag} className="small-uppercase">
                  {tag}
                </li>
              ))}
            </ul>
            ...
            {detail.recognition?.length > 0 && (
              <>
                <span
                  className="tiny-uppercase block mt-[4rem] mb-[2rem]"
                  style={{ opacity: 0.45 }}
                >
                  Recognition
                </span>
                <ul className="flex flex-col gap-[0.6rem]">
                  {detail.recognition.map((r) => (
                    <li key={r} className="small-uppercase">
                      {r}
                    </li>
                  ))}
                </ul>
          ...
          <div className="col-span-12 s:col-start-4 s:col-span-22">
            ...
            {detail.liveUrl && (
              <div className="mt-[5rem] js-t-fade">
                <Button to={detail.liveUrl} variant="light">
                  Visit live site
                </Button>
              </div>
            )}
        ...
        {detail.projects?.length > 0 &&
          detail.projects.map((project, i) => (
            <section
              key={i}
              className="site-grid mt-[10rem] s:mt-[18rem] mb-[10rem] s:mb-[18rem]"
            >
              {/* Image (left) */}
